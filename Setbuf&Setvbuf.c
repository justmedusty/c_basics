...
int main(){
    ...
    //With this invocation, stdout will not be fully buffered using our own buffer, it is fully buffered by default
    //except in a terminal environment where it is line buffered
     ...
     * anything that does not flush your strems automatically you would not see the print message and would not manually flush it yourself!
     */
