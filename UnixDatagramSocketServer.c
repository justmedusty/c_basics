...
int DatagramServer(void ){
    ...
    printf("Listening is awaiting a recvfrom call...\n");
    ...
    if((byteTotal = recvfrom(sockFd,buffer,(MAX_BYTES-1),0,((struct sockaddr *) &clientAddress),&addressLength))== -1 ){
